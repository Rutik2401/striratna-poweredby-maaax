...
@Component({
  ...
  template: `
    <a
      ...
      class="fixed bottom-6 right-6 z-40 w-14 h-14 bg-green-500 rounded-full
    ...
    >
      ...
      <!-- Tooltip -->
      <span class="absolute right-full mr-3 px-3 py-1.5 bg-gray-900 text-white text-xs font-medium
